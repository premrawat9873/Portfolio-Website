...
|---|---|---|---|---|
| A | @ | 216.150.1.1 | Auto/300s | Required: Make prem-rawat.me direct to the site |
| CNAME | www | 00cff891e0e9e3fe.vercel-dns-016.com. | Auto/300s | Optional: Make www.prem-rawat.me also accessible |
...
3. Add records one by one according to the table:
   ...
   - Host Record(Name):
     - Top-level Domain(such as prem-rawat.me) use "@"(some suppliers leave empty to represent @).
     - Subdomain(such as prem-rawat.me) use prefix "@".
...
- **Subdomain Access**: If the subdomain (such as blog.prem-rawat.me) is accessed, usually only the CNAME record in the table needs to be added.
